...
receita = pd.read_excel("./datasets/(2) receita_empresas.xlsx")
...
notas_pisa = pd.read_csv("./datasets/(2) notas_pisa.csv", sep=",", decimal=".")
...
pisa = pd.read_csv("./datasets/(2) notas_pisa.csv", delimiter=",")
...
comercio = pd.read_excel("./datasets/(2) comercio_global.xlsx")
...
atlas_ambiental = pd.read_excel("./datasets/(2) atlas_ambiental.xlsx")
...
vendas_regional = pd.read_excel("./datasets/(2) vendas_regiao.xlsx")
